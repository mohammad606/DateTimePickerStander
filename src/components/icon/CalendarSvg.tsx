const CalendarSvg = ({props,style,onClick}:{props:string,style:any,onClick:any}) => {


    return (
        <svg xmlns="http://www.w3.org/2000/svg" className={props} style={style} onClick={onClick} viewBox="0 0 24 24">
            <path
